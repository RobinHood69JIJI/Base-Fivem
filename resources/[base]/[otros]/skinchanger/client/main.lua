local Components = {
	...
	{label = _U('face'),					name = 'face',				value = 2,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = _U('skin'),					name = 'skin',				value = 4,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = _U('hair_1'),					name = 'hair_1',			value = 2,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = _U('hair_2'),					name = 'hair_2',			value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = _U('hair_color_1'),			name = 'hair_color_1',		value = 29,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	...
	{label = _U('torso_1'),					name = 'torso_1',			value = 75,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15},
	{label = _U('torso_2'),					name = 'torso_2',			value = 3,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15,	textureof	= 'torso_1'},
	...
	{label = _U('pants_1'),					name = 'pants_1',			value = 17,		min = 0,	zoomOffset = 0.8,		camOffset = -0.5},
	{label = _U('pants_2'),					name = 'pants_2',			value = 5,		min = 0,	zoomOffset = 0.8,		camOffset = -0.5,	textureof	= 'pants_1'},
	{label = _U('shoes_1'),					name = 'shoes_1',			value = 28,		min = 0,	zoomOffset = 0.8,		camOffset = -0.8},
	...
	{label = _U('eye_color'),				name = 'eye_color',			value = 8,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65},
