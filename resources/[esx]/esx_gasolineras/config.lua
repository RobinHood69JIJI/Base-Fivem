...
Config.Strings = {
	ExitVehicle = "Sal del vehiculo para llenar el depósito",
	EToRefuel = "Pulsa ~g~E ~w~ para repostar el vehiculo",
	JerryCanEmpty = "El bidón está vacio",
	FullTank = "El tanque está lleno",
	PurchaseJerryCan = "Pulsa ~g~E ~w~ para comprar un bidón de gasolina por ~g~$ " .. Config.JerryCanCost,
	CancelFuelingPump = "Pulsa ~g~E ~w~ para cancelar el repostaje",
	CancelFuelingJerryCan = "Pulsa ~g~E ~w~ para parar el llenado",
	NotEnoughCash = "No tienes dinero suficiente",
	RefillJerryCan = "Pulsa ~g~E ~w~ para rellenar el bidón por ",
	NotEnoughCashJerryCan = "No tienes suficiente dinero para llenar el bidón",
	JerryCanFull = "El bidón está lleno",
	TotalCost = "Precio",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Pulsa ~g~E ~w~para coger un bidón"
	Config.Strings.RefillJerryCan = "Pulsa ~g~E ~w~para rellenar el bidón"
end
