...
Citizen.CreateThread(function()
	for k,v in pairs(Config.Zones) do
		for i = 1, #v.Pos, 1 do
			...
			SetBlipSprite (blip, v.Icon or 52)
			SetBlipScale  (blip, v.IconScale or 1.0)
			SetBlipColour (blip, v.IconColor or 2)
			SetBlipAsShortRange(blip, true)

			BeginTextCommandSetBlipName('STRING')
			AddTextComponentSubstringPlayerName(v.Name or _U('shops'))
