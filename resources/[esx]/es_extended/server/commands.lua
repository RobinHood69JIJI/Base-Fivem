...
end, false, {help = 'TP a coordenadas', validate = true, arguments = {
	{name = 'x', help = 'X', type = 'number'},
	{name = 'y', help = 'Y', type = 'number'},
	{name = 'z', help = 'Z', type = 'number'}
}})

ESX.RegisterCommand('setjob', {'admin','mod','god'}, function(xPlayer, args, showError)
	if ESX.DoesJobExist(args.job, args.grade) then
		args.playerId.setJob(args.job, args.grade)
		args.playerId.showNotification("Nuevo trabajo: "..args.job..', rango: '..args.grade)
	else
...
ESX.RegisterCommand('car', {'admin','mod','god'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand({'cardel', 'dv'}, {'admin','mod','god'}, function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx:deleteVehicle', args.radius)
end, false, {help = _U('command_cardel'), validate = false, arguments = {
	{name = 'radius', help = _U('command_cardel_radius'), type = 'any'}
}})

ESX.RegisterCommand('setaccountmoney', {'admin','god'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('giveaccountmoney', {'admin','god'}, function(xPlayer, args, showError)
	if args.playerId.getAccount(args.account) then
...
ESX.RegisterCommand('giveitem', {'admin','god'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('giveweapon', {'admin','god'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('giveweaponcomponent', {'admin','god'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand({'clear', 'cls'}, {'user','mod','admin','god'}, function(xPlayer, args, showError)
	xPlayer.triggerEvent('chat:clear')
end, false, {help = _U('command_clear')})

ESX.RegisterCommand({'clearall', 'clsall'}, {'admin','mod','god'}, function(xPlayer, args, showError)
	TriggerClientEvent('chat:clear', -1)
end, false, {help = _U('command_clearall')})

ESX.RegisterCommand('clearinventory', {'admin','god'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('clearloadout', {'admin','god'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('setgroup', {'admin','god'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('save', {'admin','god'}, function(xPlayer, args, showError)
	ESX.SavePlayer(args.playerId)
end, true, {help = _U('command_save'), validate = true, arguments = {
	{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('saveall', {'admin','god'}, function(xPlayer, args, showError)
	ESX.SavePlayers()
