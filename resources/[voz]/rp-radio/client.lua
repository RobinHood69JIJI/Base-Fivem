...
Radio.Labels = {        
	{ "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " Guardar.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ para poner la radio ~g~on~s~.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ o ~" .. radioConfig.Controls.Increase.Name .. "~ para cambiar de frecuencia~n~~" .. radioConfig.Controls.Input.Name .. "~ elegir frecuencia~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ to ~a~ micro clicks~n~Frecuencia: ~1~ MHz" },
	{ "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " Guardar.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ para poner la radio ~r~off~s~.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ para hablar en la.~n~Frecuencia: ~1~ MHz" },
	{ "FRZL_RADIO_INPUT", "Entrar en la Frecuencia" },
}
