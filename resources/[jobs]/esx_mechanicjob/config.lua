...
Config.Zones = {
	...
	Garage = {
		Pos   = { x = -162.94, y = -1301.83, z = 200.1 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -162.94, y = -1301.83, z = 31.24 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -158.71, y = -1308.56, z = 30.0 },
