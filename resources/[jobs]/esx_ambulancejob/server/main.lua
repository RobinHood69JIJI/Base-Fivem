...
RegisterServerEvent('auxilio:alert')
AddEventHandler('auxilio:alert', function(x, y, z, message)
	TriggerClientEvent('auxilio:setBlip', -1, x, y, z, message)
end)
...
RegisterCommand('revive', function(source, args, rawCommand)
	local xPlayer = ESX.GetPlayerFromId(source)
	if not (xPlayer.getGroup() == "mod" or  xPlayer.getGroup() == "admin" or  xPlayer.getGroup() == "superadmin") then return end
	if args[1] ~= nil then
