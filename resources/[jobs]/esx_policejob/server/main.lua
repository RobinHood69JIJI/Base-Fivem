...
RegisterServerEvent('entorno:alert')
AddEventHandler('entorno:alert', function(x, y, z, message)
	TriggerClientEvent('entorno:setBlip', -1, x, y, z, message)
end)

RegisterServerEvent('forzar:alert')
AddEventHandler('forzar:alert', function(message, x, y, z)
	...
	for i=1, #xPlayers, 1 do
		...
		if xPlayer.job.name == 'police' then
			TriggerClientEvent('forzar:setBlip', xPlayers[i], x, y, z, message)
		end
	end
end)

RegisterServerEvent('alertas:active')
AddEventHandler('alertas:active', function(type)
    local source = source
    TriggerClientEvent('alertas:active', -1, type)
end)

RegisterServerEvent('alertas:disable')
AddEventHandler('alertas:disable', function()
    local source = source
    TriggerClientEvent('alertas:disable', -1)
end)
