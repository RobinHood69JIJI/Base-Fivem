    ...
    if source == 0 then
        ...
        if args[1] == nil then
            ...
            if validWeatherType then
                ...
                print("Invalid weather type, valid weather types are: \nEXTRASUNNY CLEAR NEUTRAL SMOG FOGGY OVERCAST CLOUDS CLEARING THUNDER SNOW BLIZZARD SNOWLIGHT XMAS HALLOWEEN ")
            end
        end
    else
        if isAllowedToChange(source) then
...
function NextWeatherStage()
    ...
    elseif CurrentWeather == "CLEARING" or CurrentWeather == "OVERCAST" then
        ...
        if new == 1 then
            if CurrentWeather == "CLEARING" then CurrentWeather = "FOGGY" else CurrentWeather = "EXTRASUNNY" end
        elseif new == 2 then
    ...
    elseif CurrentWeather == "THUNDER" or CurrentWeather == "EXTRASUNNY" then
        CurrentWeather = "CLEARING"
