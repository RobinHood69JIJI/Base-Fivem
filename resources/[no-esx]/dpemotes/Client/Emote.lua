...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/e', 'Realizar un emote', {{ name="emotename", help="dance, camera, sit or any valid emote."}})
    TriggerEvent('chat:addSuggestion', '/e', 'Realizar un emote', {{ name="emotename", help="dance, camera, sit or any valid emote."}})
    TriggerEvent('chat:addSuggestion', '/emote', 'Realizar un emote', {{ name="emotename", help="dance, camera, sit or any valid emote."}})
    ...
    TriggerEvent('chat:addSuggestion', '/emotemenu', 'Abre el F3 para abrir los emotes.')
    TriggerEvent('chat:addSuggestion', '/emotes', 'Lista de todos los emotes disponibles.')
    TriggerEvent('chat:addSuggestion', '/walk', 'Selecciona tu forma de caminar.', {{ name="style", help="/walks para observar toda la lista de posibles andares."}})
